...
import { Card, Icon, Title } from "../styles/Admin_settings_sc";
const sections = [
  {
    title: "Paramètres généraux",
    icon: <FaCogs />,
    link: "/admniPage/Settings/general",
  },
  {
    title: "Gestion des utilisateurs",
    icon: <FaUsers />,
    link: "/admniPage/Settings/users",
  },
  {
  ...
  },
  {
    title: "Apparence",
    icon: <FaPalette />,
    link: "/admniPage/Settings/appearance",
  },
  {
    title: "Notifications",
    icon: <FaBell />,
    link: "/admniPage/Settings/notifications",
  },
  { title: "Sécurité", icon: <FaLock />, link: "/admniPage/Settings/security" },
  {
    title: "Sauvegarde et maintenance",
    icon: <FaDatabase />,
    link: "/admniPage/Settings/backup",
  },
  {
    title: "Intégrations",
    icon: <FaPuzzlePiece />,
    link: "/admniPage/Settings/integrations",
  },
];
