...
import StatCard from "../Admin_page/StatCard";
...
const statsData = [
  { title: "Utilisateurs", value: 1500, icon: user },
  { title: "Jeux Uploadés", value: 250, icon: game },
  { title: "Visites Totales", value: 4800, icon: stats },
];
